...
comp_de_norm %>% 
  ...
  write_tsv("/Users/shaman.narayanasamy/Work/Data/KAUST/membrane_cleaning/differential_expression_results-2FC_0.05FDR.tsv")
...
comp_de_bflush %>% 
  ...
  select(feature, phase, everything()) %>% 
  write_tsv("/Users/shaman.narayanasamy/Work/Data/KAUST/membrane_cleaning/differential_expression_results-2FC_0.05FDR.tsv", append = T)
```
